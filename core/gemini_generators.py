...
class GeminiProductSelector:
    ...
    def analyze_candidates(self, category: str, products: list) -> list:
        ...
        prompt = (
            ...
            "CRITERIA:\n"
            "1. Profit Maximization: Prioritize products with a price GREATER THAN $30 USD. Absolute commission matters more than percentage.\n"
            "2. High Commission: Target products yielding $5+ USD per sale.\n"
            "3. High Rotation: BSR < 100,000.\n"
            "4. High Conversion: Rating 4.0+ and Prime availability.\n\n"
