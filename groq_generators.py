...
class GroqProductSelector:
    ...
    def analyze_candidates(self, category: str, products: list) -> list:
        ...
        prompt = (
            ...
            "1. High Commission: Target products yielding $5+ USD per sale (calculate based on price and commission_rate).\n"
            "2. High Rotation: BSR (Best Sellers Rank) should be < 50,000 in main categories.\n"
            "3. High Conversion: Rating 4.3+ and Prime availability are MUSTS.\n"
            "4. Low Competition: Balance popularity with uniqueness.\n\n"
